export type RendererKey = 'GENERIC' | 'PHYSICAL_EXAMINATION' | 'DENTAL_EXAMINATION' | 'TREADMILL_SCREENING' | 'VISUAL_FIELD_TEST' | 'ROMBERG_TEST' | 'TINNEL_TEST' | 'PHALLEN_TEST' | 'RECTAL_EXAMINATION'
