...
const empTabs = [
  ...
  { id: 'leave', label: 'Leave', icon: 'i-lucide-calendar-check' }
]
...
<template>
  <div class="w-full">
    ...
    <UAlert
      ...
      description="Data profile tidak ditemukan."
      color="error"
    ...
    <template v-else-if="employeeData">
          ...
          <div v-if="leaveBalanceData.length" class="shrink-0 w-56 space-y-3">
            <div v-for="lb in leaveBalanceData" :key="lb.id" class="rounded-xl border border-default bg-elevated/40 p-4">
              ...
              <p class="text-xs text-muted mt-1">
                Sisa dari {{ lb.jatah_cuti_baru }} jatah cuti baru
              </p>
      ...
      <UPageCard variant="subtle">
        <template #header>
          <p class="text-sm text-muted">
            {{ { basic: 'Informasi dasar employee', personal: 'Data pribadi', education: 'Riwayat pendidikan', contact: 'Kontak darurat', children: 'Data anak', position: 'Posisi dan jabatan', document: 'Nomor dokumen', health: 'Data kesehatan', leave: 'Saldo cuti tahunan' }[employeeTab] || 'Data employee' }}
          </p>
        </template>
        ...
        <div v-if="employeeTab === 'basic'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              NIK
            </p><p class="mt-1 font-medium text-highlighted">
              {{ employeeData.nik || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
        ...
        <div v-else-if="employeeTab === 'personal'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.no_ktp || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.no_kk || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.tempat_lahir || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ fmtDate(employeeData.employeePersonal?.[0]?.tanggal_lahir) }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.jenis_kelamin || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.nama_ibu_kandung || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.alamat_ktp || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.alamat_domisili || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ fmtDate(employeeData.employeePersonal?.[0]?.tanggal_abis_ktp) }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.religion?.nama_agama || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.blood_type?.kode || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeePersonal?.[0]?.marital_status?.nama || '-' }}
            </p>
          </div>
        </div>

        <div v-else-if="employeeTab === 'education'" class="space-y-3">
          <p v-if="!employeeData.educations?.length" class="text-sm text-muted">
          ...
          <div v-for="edu in employeeData.educations" :key="edu.id" class="rounded-xl border border-default p-4">
            ...
            <p class="text-sm text-muted mt-1">
              {{ edu.jurusan }} — {{ edu.tahun_masuk }}–{{ edu.tahun_lulus }}
            </p>
          </div>
        </div>

        <div v-else-if="employeeTab === 'contact'" class="space-y-3">
          <p v-if="!employeeData.employee_emergency_contacts?.length" class="text-sm text-muted">
          ...
          <div v-for="c in employeeData.employee_emergency_contacts" :key="c.id" class="rounded-xl border border-default p-4">
            ...
            <p class="text-sm text-muted mt-1">
              {{ c.hubungan }} · {{ c.telepon }}
            </p>
          </div>
        </div>

        <div v-else-if="employeeTab === 'children'" class="space-y-3">
          <p v-if="!employeeData.empleyeeChild?.length" class="text-sm text-muted">
            Tidak ada data anak.
          </p>
          <div v-for="child in employeeData.empleyeeChild" :key="child.id" class="rounded-xl border border-default p-4">
            ...
            <p class="text-sm text-muted">
              Tgl Lahir: {{ fmtDate(child.tanggal_lahir) }} | Pendidikan: {{ child.pendidikan || '-' }} | Pekerjaan: {{ child.pekerjaan || '-' }}
            </p>
          </div>
        </div>

        <div v-else-if="employeeTab === 'position'" class="space-y-3">
          <p v-if="!employeeData.employeePosition?.length" class="text-sm text-muted">
          ...
          <div v-for="pos in employeeData.employeePosition" :key="pos.id" class="rounded-xl border border-default p-4">
            <p class="font-medium">
              {{ pos.department?.nama_department || '-' }}
            </p>
            <p class="text-sm text-muted mt-1">
              {{ pos.section?.nama || '-' }}
            </p>
        ...
        <div v-else-if="employeeTab === 'document'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_npwp || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_asuransi || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_jamsostek || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_bpjs_kesehatan || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_bpjs_ketenagakerjaan || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeDocument?.[0]?.no_dplk || '-' }}
            </p>
          </div>
        </div>
        ...
        <div v-else-if="employeeTab === 'health'" class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.tinggi_badan || '-' }} cm
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.berat_badan || '-' }} kg
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.kacamata ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.alergi || '-' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_bicara ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_pendengaran ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_penglihatan ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_anggota_badan ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_lain ? 'Ya' : 'Tidak' }}
            </p>
          </div>
          <div class="rounded-xl border border-default bg-elevated/40 p-4">
            <p class="text-xs text-muted">
              ...
              {{ employeeData.employeeHealth?.[0]?.cacat_penjelasan || '-' }}
            </p>
          </div>
        </div>

        <div v-else-if="employeeTab === 'leave'" class="space-y-3">
          <p v-if="!leaveBalanceData.length" class="text-sm text-muted">
          ...
          <div v-for="lb in leaveBalanceData" :key="lb.id" class="rounded-xl border border-default p-4 flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-muted">
                Jatah Baru: {{ lb.jatah_cuti_baru }} | Sisa: {{ lb.sisa_baru }}
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <UFormField name="phone" label="Phone">
              <UInput v-model="profile.phone" placeholder="+62..." class="w-full" />
            </UFormField>
